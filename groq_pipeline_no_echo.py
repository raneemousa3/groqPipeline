"""
Groq Pipeline (No Echo): Prevents AI from responding to its own speech

This version completely stops microphone input while AI is speaking.
"""
...
class GroqPipeline:
    """Main pipeline orchestrating STT → LLM → Text Response flow with echo prevention"""
    ...
    async def audio_generator(self) -> None:
        """Capture audio from microphone and put in queue - stops when AI is speaking"""
    ...
    async def play_audio(self, filename: str):
        ...
        try:
            ...
            print("🔇 Microphone muted during AI response...")
    ...
    async def deepgram_loop(self) -> None:
        ...
        async with connect(
            ...
            print("🎤 Listening (Echo Protected)... Press CTRL+C to stop")
            print("💡 Speak clearly and wait for the response before speaking again")
            print("🔇 Microphone will be muted during AI responses")
