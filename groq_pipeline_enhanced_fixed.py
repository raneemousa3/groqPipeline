"""
Enhanced Groq Pipeline (Fixed): Continuous listening with enhanced features

This version ensures continuous speech recognition without getting stuck on audio playback.
"""
...
class EnhancedGroqPipeline:
    """Enhanced pipeline with core improvements and continuous listening"""
                ...
                if transcript.strip():
                    ...
                    async with self.processing_lock:
                        ...
                        if audio_file:
                            ...
                            # Play audio in background so we can continue listening
                            asyncio.create_task(self.play_audio(audio_file))
                        else:
