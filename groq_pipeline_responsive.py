"""
Groq Pipeline (Responsive): Better microphone management and speech detection

This version has improved microphone handling and more responsive speech detection.
"""
...
class GroqPipeline:
    """Main pipeline orchestrating STT → LLM → Text Response flow with responsive microphone"""
    ...
    async def audio_generator(self) -> None:
        """Capture audio from microphone and put in queue - with better management"""
    ...
    async def play_audio(self, filename: str):
        """Play audio file and clean up - with better microphone management"""
        try:
    ...
    async def deepgram_loop(self) -> None:
        ...
        async with connect(
            ...
            print("🎤 Listening (Responsive Mode)... Press CTRL+C to stop")
