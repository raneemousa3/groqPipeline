"""
Groq Pipeline: Speech → Text → LLM Processing → Text Response

This pipeline integrates:
1. Real-time STT (Deepgram)
2. LLM processing (Groq)
3. Context management and prompt engineering
4. Text-based responses (TTS can be added later)
"""
...
class GroqPipeline:
    """Main pipeline orchestrating STT → LLM → Text Response flow"""
    ...
    async def deepgram_loop(self) -> None:
        ...
        async with connect(
            ...
            print("💬 Responses will be shown as text (TTS can be added later)")
