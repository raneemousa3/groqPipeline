"""
Enhanced Groq Pipeline (Simplified): Advanced Speech → Text → LLM Processing → Intelligent Speech Response

This enhanced pipeline includes core improvements:
1. Real-time STT (Deepgram) - using proven configuration
...
class EnhancedGroqPipeline:
    """Enhanced pipeline with core improvements"""
